        ...
        <div class="right">
            ...
            <form action="#" method="get" id="searchFrm">
                <fieldset>
                    ...
                    <input type="text" placeholder="상품명을 입력해주세요" id="serchTxt">
            ...
            <a href="#" id="./review.html"><img src="./images/icon_cart.png" alt="장바구니"></a>
        ...
        <div id="open_nav">
            ...
            <div class="swiper" id="nav_adver">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <a href="#">무료 배송 반품 서비스로 젠틀몬스터의 서비스를 경험해보세요.</a>
                    </div>
                </div>
